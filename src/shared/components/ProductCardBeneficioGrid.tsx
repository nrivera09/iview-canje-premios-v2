  ...
  return (
    ...
    >
      ...
      <div className="product flex flex-col w-full h-full">
        ...
        <div className="title flex-1 pt-1 px-1 h-[34px] flex items-center justify-start">
          <span className="text-[14px] text-black font-bold truncate-2-lines leading-4 pl-1 pr-1 capitalize">
            {beneficio.nombre}
          </span>
        </div>
      </div>
